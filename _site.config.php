...
$site_config = array(
    'site_name'           => '온오프마케팅',
    'site_desc'           => '성과형 마케팅 · 홈페이지 제작 · 자동화 플랫폼',
    'company_name'        => '온오프마케팅',
    'ceo_name'            => '김에리사',
    'business_no'         => '554-08-02817',
    'phone'               => '0503-6982-1200',
    'kakao_url'           => '#',
    'email'               => 'jong8040@gmail.com',
    'address'             => '서울특별시 서초구 강남대로 479, 185호',
    ...
    'footer_desc'         => 'SEO와 AEO 구조 설계가 포함된 홈페이지 제작부터 노출을 위한 트래픽, 포스팅 실행까지. 매출을 만드는 디지털 마케팅 에이전시.',
    ...
    'home_builder_bridge_id'    => 'onoffmarketing',
);
